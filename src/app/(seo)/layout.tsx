          ...
          <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-[#6b7280]">
                  <li>
                    <Link href="/seguros/auto" className="hover:text-[#111827]">
                      Seguro de Auto
                    </Link>
                  </li>
                  <li>
                    <Link href="/seguros/salud" className="hover:text-[#111827]">
                      Seguro de Salud
                    </Link>
                  </li>
                  <li>
                    <Link href="/seguros/vida" className="hover:text-[#111827]">
                      Seguro de Vida
                    </Link>
                  </li>
                  <li>
                    <Link href="/seguros/hogar" className="hover:text-[#111827]">
                      Seguro de Hogar
                    </Link>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-[#6b7280]">
                  <li>
                    <Link href="/sobre-nosotros" className="hover:text-[#111827]">
                      Sobre Nosotros
                    </Link>
                  </li>
                  <li>
                    <Link href="/contacto" className="hover:text-[#111827]">
                      Contacto
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href="/para-brokers" className="hover:text-[#111827]">
                      Para Brokers
                    </Link>
                  </li>
                </ul>
            ...
            <div className="mt-8 border-t border-[#e5e7eb] pt-8 text-center text-sm text-[#6b7280]">
              ...
              <div className="mt-2 flex justify-center gap-4">
                <Link href="/privacidad" className="hover:text-[#111827]">
                  Privacidad
                </Link>
                <Link href="/terminos" className="hover:text-[#111827]">
                  Términos
                </Link>
              </div>
            </div>
