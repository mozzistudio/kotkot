    ...
    return (
      <div className="flex min-h-[70vh] items-center justify-center px-4 pt-32">
        <div className="bg-white border border-[var(--border-default)] rounded-[var(--radius-card)] mx-auto max-w-lg p-12 text-center">
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-[var(--radius-md)] bg-[rgba(202,255,4,0.15)]">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-5 lg:gap-16">
            ...
            <form onSubmit={handleSubmit} className="bg-white border border-[var(--border-default)] rounded-[var(--radius-card)] p-8 sm:p-10">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <select
                    ...
                    value={formData.pais}
                    onChange={handleChange}
                    className="w-full rounded-xl border border-[var(--border-default)] bg-white px-4 py-2.5 text-sm text-[var(--text-primary)] shadow-sm transition-all duration-200 focus:border-[var(--accent)] focus:outline-none focus:ring-2 focus:ring-[rgba(202,255,4,0.20)]"
                  >
              ...
              <div className="mt-8">
                <button
                  ...
                  className="inline-flex w-full items-center justify-center gap-2 rounded-[var(--radius-card)] bg-[var(--accent)] border border-[rgba(202,255,4,0.40)] px-8 py-4 text-lg font-semibold text-[var(--text-primary)] shadow-xl shadow-[rgba(202,255,4,0.25)] transition-all duration-200 hover:shadow-[rgba(202,255,4,0.4)] hover:brightness-110 disabled:pointer-events-none disabled:opacity-50 sm:w-auto"
                >
                  {isSubmitting ? (
                    <>
                      <svg
          ...
          <div className="lg:col-span-2">
                ...
                {benefits.map((benefit) => (
                  <li key={benefit.text} className="flex items-start gap-3">
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[rgba(202,255,4,0.15)]">
                      <benefit.icon className="h-4 w-4 text-[var(--text-primary)]" />
                    </div>
            ...
            {/* Trust badge */}
            <div className="mt-6 bg-white border border-[var(--border-default)] rounded-[var(--radius-card)] p-6 text-center">
