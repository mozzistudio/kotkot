      ...
      <div className="card">
        ...
        {activeTab === 'profile' && (
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              <div className="flex h-20 w-20 items-center justify-center rounded-full border-2 border-dashed border-[var(--border)] text-[var(--text-tertiary)] transition-colors hover:border-[#0C1E35] hover:text-[#0C1E35]">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-[var(--border)] px-4 py-2.5 text-sm text-[var(--text-primary)] focus:border-[#0C1E35]/50 focus:outline-none focus:ring-1 focus:ring-[rgba(12,30,53,0.06)]/20"
                />
              </div>
              <div>
            ...
            <button className="inline-flex items-center gap-2 rounded-lg bg-[#0C1E35] text-[var(--text-on-accent)] transition-all hover:bg-[#0C1E35]/90">
        ...
        {activeTab === 'billing' && (
          <div className="space-y-6">
            ...
            {/* Current Plan */}
            <div className="rounded-lg border border-[#0C1E35] bg-[rgba(12,30,53,0.06)] p-5">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[rgba(12,30,53,0.06)]">
                    <Crown className="h-5 w-5 text-[#0C1E35]" />
                  </div>
                  <div>
                ...
                <span className="rounded-full border border-[#0C1E35] bg-[rgba(12,30,53,0.06)] px-3 py-1 text-xs font-medium text-[#0C1E35]">
                  Activo
                </span>
              </div>
              ...
              <button className="mt-4 inline-flex items-center gap-2 rounded-lg border border-[#0C1E35] bg-[rgba(12,30,53,0.06)] px-4 py-2 text-sm font-medium text-[#0C1E35] transition-colors hover:bg-[rgba(12,30,53,0.10)]">
                ...
                {invoices.map((inv) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="rounded-full border border-[#0C1E35] bg-[rgba(12,30,53,0.06)] px-2 py-0.5 text-xs text-[#0C1E35]">
                        Pagada
                      </span>
                    </div>
                  </div>
          ...
          <div className="space-y-6">
            ...
            {demoCountry === 'PA' ? (
              ...
              <div className="space-y-5">
                <div className="rounded-lg border border-[#0C1E35] bg-[rgba(12,30,53,0.06)] p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="ml-auto rounded-full border border-[#0C1E35] bg-[rgba(12,30,53,0.06)] px-2.5 py-0.5 text-xs font-medium text-[#0C1E35]">
                      Conectado
                    </span>
                  </div>
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-[var(--border)] px-4 py-2.5 text-sm text-[var(--text-primary)] font-mono focus:border-[#0C1E35]/50 focus:outline-none focus:ring-1 focus:ring-[rgba(12,30,53,0.06)]/20"
                    />
                  </div>
                  <div>
                    <label className="mb-1.5 block text-sm font-medium text-[var(--text-primary)]">
                ...
                <div className="flex gap-3">
                  ...
                  <button className="inline-flex items-center gap-2 rounded-lg border border-[var(--border)] px-5 py-2.5 text-sm font-medium text-[var(--text-secondary)] transition-colors hover:border-[#0C1E35] hover:text-[#0C1E35]">
                    <Zap className="h-4 w-4" />
                    Probar Conexion
                  </button>
                </div>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <select
                        ...
                        className="rounded-md border border-[var(--border)] bg-white px-2 py-1 text-xs text-[var(--text-primary)] focus:border-[#0C1E35]/50 focus:outline-none"
                      >
